...
{
    public class Background30 : BackgroundService
    {
        private readonly ILogger<Background30> _logger;
        private readonly IServiceProvider _serviceProvider;
        private readonly IConfiguration _configuration;

        public Background30(IConfiguration configuration, ILogger<Background30> logger, IServiceProvider serviceProvider)
        {
            _logger = logger;
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                {
                    _logger.LogError(ex, "Background processing per 30 seconds failed");
                    Console.WriteLine($"Background processing per 30 seconds failed: {ex.Message}");
                }
