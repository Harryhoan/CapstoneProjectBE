...
namespace Application.Utils.Vnpay
{
    internal class PaymentHelper
    {
        ...
        internal string GetPaymentUrl(string baseUrl, string hashSecret)
        {
            ...
            var secureHash = HashPassWithSHA256.AsHmacSHA512(hashSecret, signData);
        ...
        internal bool IsSignatureCorrect(string? inputHash, string secretKey)
        {
            ...
            var checksum = HashPassWithSHA256.AsHmacSHA512(secretKey, rspRaw);
